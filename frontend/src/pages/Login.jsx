...
export default function Login() {
  ...
  const handleAdminSignIn = () => {
    if (!email || !password) {
      setError(
        'Enter your email and password, then use Sign in as Admin.'
      )
      return
    }
    ...
    <div className="signin-layout">
      ...
      <aside className="signin-side">
        ...
        <p className="signin-desc">
          Nagorik is a modern civic-tech platform for reporting,
          discussing, and tracking local community issues. Built as
          a university project, it connects citizens through community
          engagement and helps prioritize issues based on public feedback.
        </p>
