    ...
    <article className="flex items-center gap-[18px] rounded-2xl border border-nagorik-light-red bg-[linear-gradient(90deg,var(--color-nagorik-soft-red),var(--color-nagorik-paper)_62%)] p-3.5 max-[760px]:flex-col max-[760px]:items-stretch">
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-[7px]">
        <div className="flex flex-wrap items-center gap-3">
          <h3 className="m-0 text-[15px] font-extrabold text-nagorik-heading">
            {issue.title}
          </h3>
          <span
            className={`inline-flex items-center gap-[5px] rounded-full px-[11px] py-1 text-[10.5px] font-bold text-white ${badgeBg}`}
          >
        ...
        {expanded && (
          <div className="mt-3 border-t border-nagorik-border pt-1">
            <div className="flex gap-[24px] border-b border-nagorik-cream py-3 text-[13.5px]">
              ...
              <span className="font-bold text-nagorik-heading break-words">
                {issue.category || "—"}
              </span>
            </div>
            <div className="flex gap-[24px] border-b border-nagorik-cream py-3 text-[13.5px]">
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-[1160px] px-7 pt-7 pb-[60px] max-[760px]:px-4">
        <section
          className="relative isolate z-0 flex flex-col overflow-hidden rounded-[18px] p-[30px_32px_26px]"
          style={{
            backgroundImage: `url(${profileBg}), linear-gradient(135deg, #d5d5d3, #c4c4c2)`,
        ...
        >
          ...
          <div className="mt-auto pt-6">
            <h2 className="mb-3 text-[15px] font-extrabold text-[#26261f] dark:text-nagorik-heading">
              Contributions
            </h2>
              ...
              {[
                {
                  ...
                  icon: <EditPenIcon size={17} />,
                  count: reports.length,
                },
                {
                  label: "Upvotes Given",
                  icon: <VoteUpIcon size={17} />,
                  count: upvotedIssues.length,
                },
                {
                  label: "Comments made",
                ...
                <div
                  className="flex min-h-[98px] flex-col rounded-[10px] bg-white p-[13px_18px_14px] shadow-[0_6px_14px_-10px_rgba(0,0,0,0.3)] dark:bg-nagorik-surface"
                  key={card.label}
                >
                  <span className="text-[12px] font-semibold text-[#a3a39e]">
                    {card.label}
                  </span>
        ...
        <div className={activeTab === "reports" ? "block" : "hidden"}>
          <div className="mt-[26px] mb-3.5 flex items-center justify-between">
            <h2 className="m-0 text-[17px] font-extrabold text-nagorik-heading">
              Reports submitted by you
            </h2>
            <span className="text-[13px] text-nagorik-muted">
